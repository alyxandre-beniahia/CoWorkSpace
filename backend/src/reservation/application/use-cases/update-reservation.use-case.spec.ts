...
describe('UpdateReservationUseCase', () => {
  ...
  it("lance ReservationForbiddenError si l'utilisateur ne possède pas la réservation", async () => {
    ...
    ).rejects.toThrow(ReservationForbiddenError);
  });

  it('lance ReservationConflictError si date de fin <= date de début', async () => {
    await expect(
  ...
  it('lance ReservationConflictError si le nouveau créneau chevauche une autre réservation', async () => {
