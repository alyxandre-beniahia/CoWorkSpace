...
describe('expandRecurrence', () => {
  ...
  it('conserve la durée du créneau initial pour chaque occurrence', () => {
    ...
    const result = expandRecurrence('FREQ=DAILY', start, end, recurrenceEndAt);
  ...
  it('avec timeZone Europe/Paris conserve la même heure locale après passage à l’heure d’été', () => {
    // 28 mars 2026 10:00 Paris (CET) = 09:00 UTC
    const firstStart = new Date('2026-03-28T09:00:00Z');
    const firstEnd = new Date('2026-03-28T10:00:00Z');
