...
import { Prisma, SpaceType as PrismaSpaceType } from '@prisma/client';
...
import type { SeatListItem, SpaceListItem, SpaceWithEquipements } from '../../domain/entities/space.entity';
